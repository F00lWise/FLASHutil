...
x = midpoints(mes.binn_edges)-2892#np.linspace(0, 10, 201)
y = mes.diff_binned-baseline#step(x, amplitude=12.5, center=4.5, sigma=0.88, form='erf')
#np.random.seed(0)
...
axes[1].plot(x, y, 'bo')
axes[1].plot(x, 1*comps['jump'], 'k--', label='Jump component')
